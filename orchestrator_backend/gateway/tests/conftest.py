...
def admin_user(django_user_model):
    ...
    user = django_user_model.objects.create_user(username='admin_user', password='pass1234')
...
def employee_user(django_user_model):
    ...
    user = django_user_model.objects.create_user(username='employee_user', password='pass1234')
